...
export default function Login() {
  ...
  return (
    <div className="login-container">
      {/* Left Side: Wallpaper & App Info */}
      <div className="login-left">
        <div className="wallpaper-content">
          <div className="app-brand">
            <Sparkles size={40} className="brand-logo" />
            <span className="brand-name">SalaryCalc</span>
          </div>

          <div className="wallpaper-text">
            <h1>Expert Tools for Your Career</h1>
            <p>Everything you need to advance your professional journey in one place.</p>
